...
interface ByDateThreatsClientProps {
  articles: Article[]
  initialDate: string
}

export function ByDateThreatsClient({ articles, initialDate }: ByDateThreatsClientProps) {
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h1 className="text-3xl font-bold flex items-center gap-2">
                          ...
                          Threats - {formattedDate}
                        </h1>
                        <p className="text-muted-foreground mt-1">
                          Threat articles published on {formattedDate}
                        </p>
                      </div>
                    </div>
