...
interface ByDateOpportunitiesClientProps {
  articles: Article[]
  initialDate: string
}

export function ByDateOpportunitiesClient({ articles, initialDate }: ByDateOpportunitiesClientProps) {
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h1 className="text-3xl font-bold flex items-center gap-2">
                          <IconBulb className="size-8 text-green-600" />
                          Opportunities - {formattedDate}
                        </h1>
                        <p className="text-muted-foreground mt-1">
                          Opportunity articles published on {formattedDate}
                        </p>
                      </div>
                    </div>
