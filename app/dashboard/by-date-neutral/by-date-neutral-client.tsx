...
interface ByDateNeutralClientProps {
  articles: Article[]
  initialDate: string
}

export function ByDateNeutralClient({ articles, initialDate }: ByDateNeutralClientProps) {
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h1 className="text-3xl font-bold flex items-center gap-2">
                          ...
                          Neutral - {formattedDate}
                        </h1>
                        <p className="text-muted-foreground mt-1">
                          Neutral articles published on {formattedDate}
                        </p>
                      </div>
                    </div>
