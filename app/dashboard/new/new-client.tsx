...
export function NewPageClient({ articles }: NewPageClientProps) {
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h1 className="text-3xl font-bold flex items-center gap-2">
                        <IconAlertCircle className="size-8 text-orange-600" />
                        New Threats/Opportunities
                      </h1>
                      <p className="text-muted-foreground mt-1">
                        Unreviewed articles awaiting your feedback
                      </p>
                    </div>
                  </div>
                  <Badge variant="outline" className="text-orange-600 border-orange-600 dark:text-orange-400 text-lg px-4 py-2">
